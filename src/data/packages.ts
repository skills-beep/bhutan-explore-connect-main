...
export const destinations: Destination[] = [
  {
    ...
    mustDo: ["Hike to Taktsang Monastery", "Walk through old Paro town", "Visit the National Museum"],
    bestFor: ["First-time travelers", "Cultural explorers", "Hikers and photographers"],
    image: "",
    packageCount: 6,
  },
  {
    ...
    mustDo: ["Visit Tashichho Dzong", "Explore the craft bazaar", "See the giant Buddha statue"],
    bestFor: ["City breaks", "Culture lovers", "Shopping and food"],
    image: "",
    packageCount: 5,
  },
  {
    ...
    mustDo: ["Drive over Dochula Pass", "See Punakha Dzong", "Visit riverfront villages"],
    bestFor: ["Scenic drives", "Nature lovers", "Couples and photographers"],
    image: "",
    packageCount: 3,
  },
  {
    ...
    mustDo: ["Visit ancient lhakhangs", "Experience local weaving", "Explore the valley's monasteries"],
    bestFor: ["Spiritual travelers", "Culture seekers", "Slow travel"],
    image: "",
    packageCount: 2,
  },
  {
    ...
    mustDo: ["Watch cranes in winter", "Walk the meadow trails", "Visit Gangtey Monastery"],
    bestFor: ["Nature retreats", "Birdwatchers", "Peaceful escapes"],
    image: "",
    packageCount: 2,
  },
  {
    ...
    mustDo: ["Cross Chele La Pass", "Visit local villages", "Enjoy the quiet alpine scenery"],
    bestFor: ["Off-grid travelers", "Hidden gems", "Mountain scenery"],
    image: "",
    packageCount: 1,
  },
];
